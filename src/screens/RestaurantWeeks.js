...
const styles = StyleSheet.create({
  ...
  optionText: { fontFamily: 'Montserrat', fontSize: 15, color: '#626262', fontWeight: '400', marginLeft: 10, textDecorationLine: 'underline' },
  ...
  text: { fontFamily: 'Montserrat', fontWeight: '400', fontSize: 15, color: '#121212', lineHeight: 22.5 },
