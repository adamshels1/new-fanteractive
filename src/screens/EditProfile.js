...
const styles = StyleSheet.create({
  ...
  name: { fontFamily: 'Avenir', color: '#121212', fontWeight: '400', fontSize: 24, marginTop: 18 },
  email: { fontFamily: 'Avenir', color: '#7A7A7A', fontWeight: '400', fontSize: 16, marginTop: 7 },
  text2: { fontFamily: 'Avenir', color: '#7A7A7A', fontWeight: '400', fontSize: 16, marginTop: 31 },
  pointsLabel: { fontFamily: 'Avenir', color: '#121212', fontWeight: '400', fontSize: 15, marginTop: 18 },
  points: { fontFamily: 'Avenir', color: '#F2A71D', fontWeight: '700', fontSize: 34, marginTop: 6 },
