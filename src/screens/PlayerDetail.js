    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <View
          ...
          <TouchableOpacity onPress={() => navigation.navigate('PlayerSummary')}>
            <Text
              style={{
                color: '#7D86A9',
                fontFamily: 'Oswald',
          ...
          <FlatList
            ...
            renderItem={() => (
              <ListItem
                ...
                icon={{
                  uri:
                    'https://images.thestar.com/cRSu4APBLry9mJ9ZFnuAjfZkEx4=/1280x1024/smart/filters:cb(1508214149486)/https://www.thestar.com/content/dam/thestar/sports/amateur/2014/12/23/innocent_competitive_cyclist_cant_shake_doping_record/web_photo_jack_burke.jpg',
                }}
