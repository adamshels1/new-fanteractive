...
const styles = StyleSheet.create({
  ...
  bodyTitle: { fontWeight: '400', fontFamily: 'Montserrat', fontSize: 24, color: '#121212' },
  desc: { marginTop: 30, fontWeight: '400', fontFamily: 'Montserrat', color: '#7A7A7A', fontSize: 16, textAlign: 'center', lineHeight: 27 },
  image: { width: 81, height: 81, marginTop: 40 },
  confirmButton: { marginTop: 27, marginBottom: 50 },
  sendAgainText: { color: '#F2A71D', fontWeight: '600', fontFamily: 'Montserrat', fontSize: 14 },
  sendAgain: { alignItems: 'center', marginTop: 40 },
  version: { fontWeight: '400', fontFamily: 'Montserrat', fontSize: 11, color: '#A1A1A1', paddingBottom: 30 },
})