...
const styles = StyleSheet.create({
  ...
  forgot: { color: '#378BED', fontFamily: 'Avenir', fontWeight: '600', fontSize: 14 },
  ...
  agree: { color: '#7A7A7A', fontFamily: 'Avenir', fontWeight: '600', fontSize: 12, marginLeft: 8 },
  ...
  title2: { fontFamily: 'Avenir', color: '#F2A71D', fontWeight: '400', fontSize: 16 },
  text: { fontFamily: 'Avenir', fontWeight: '400', color: '#121212', fontSize: 14, lineHeight: 18, paddingTop: 13 },
  visitWeb: { fontFamily: 'Avenir', color: '#378BED', fontWeight: '600', fontSize: 15 },
